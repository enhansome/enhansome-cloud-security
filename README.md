...
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,677 | 🐛 280 | 🌐 Python | 📅 2026-08-25: Command line tool for AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
...
* [checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,974 | 🐛 167 | 🌐 Python | 📅 2026-08-23: A static code analysis tool for infrastructure-as-code.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,933 | 🐛 16 | 🌐 Go | 📅 2026-08-24: A Postgres FDW that maps APIs to SQL, plus suites of [API plugins](https://hub.steampipe.io/plugins) and [compliance mods](https://hub.steampipe.io/mods) for AWS/Azure/GCP and many others.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,800 | 🐛 296 | 🌐 Python | 📅 2025-09-23: Multi-cloud security auditing tool.
* [tfsec](https://github.com/liamg/tfsec) ⭐ 7,032 | 🐛 18 | 🌐 Go | 📅 2026-03-25: Static analysis powered security scanner for Terraform code.
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,495 | 🐛 167 | 🌐 Go | 📅 2026-08-25: Open source cloud asset inventory with set of pre-baked SQL [policies](https://hub.cloudquery.io/policies) for security and compliance.
* [Cloudmapper](https://github.com/duo-labs/cloudmapper) ⭐ 6,288 | 🐛 210 | 🌐 JavaScript | 📅 2024-07-15: Analyze your AWS environments.
* [Cloud-custodian](https://github.com/cloud-custodian/cloud-custodian) ⭐ 6,053 | 🐛 1,740 | 🌐 Python | 📅 2026-08-25: Rules engine for cloud security, cost optimization, and governance.
...
* [pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,310 | 🐛 37 | 🌐 Python | 📅 2026-05-19: The AWS exploitation framework.
...
* [Cloudsploit](https://github.com/aquasecurity/cloudsploit) ⭐ 3,768 | 🐛 213 | 🌐 JavaScript | 📅 2026-07-28: Cloud security configuration checks.
* [consoleme](https://github.com/Netflix/consoleme) ⚠️ Archived: A Central Control Plane for AWS Permissions and Access
* [kics](https://github.com/Checkmarx/kics) ⭐ 2,694 | 🐛 324 | 🌐 Open Policy Agent | 📅 2026-08-25: Find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle of your infrastructure-as-code.
...
* [PMapper](https://github.com/nccgroup/PMapper) ⭐ 1,575 | 🐛 36 | 🌐 Python | 📅 2024-08-02: A tool for quickly evaluating IAM permissions in AWS.
...
* [cloudlist](https://github.com/projectdiscovery/cloudlist) ⭐ 1,048 | 🐛 5 | 🌐 Go | 📅 2026-08-17: Listing Assets from multiple Cloud Providers.
...
* [dftimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 353 | 🐛 5 | 🌐 Python | 📅 2026-08-21: A multi-cloud framework for orchestrating forensic collection, processing and data export.
...
* [Falco](https://github.com/falcosecurity/falco) ⭐ 9,303 | 🐛 64 | 🌐 C++ | 📅 2026-08-03: Container runtime security.
* [mkit](https://github.com/darkbitio/mkit) ⚠️ Archived: Managed kubernetes inspection tool.
* [auditkube](https://github.com/opszero/auditkube) ⭐ 117 | 🐛 2 | 🌐 HCL | 📅 2026-08-17: Audit for for EKS, AKS and GKE for HIPAA/PCI/SOC2 compliance and cloud security.
* [Open policy agent](https://www.openpolicyagent.org/): Policy-based control tool.

## SaaS

* [cloudsplaining](https://github.com/salesforce/cloudsplaining) ⭐ 2,243 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-16: An AWS IAM Security Assessment tool that identifies violations of least privilege and generates a risk-prioritized report.
...
* [cloudgoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,708 | 🐛 24 | 🌐 Python | 📅 2026-04-28: "Vulnerable by Design" AWS deployment tool.
...
* [TerraGoat](https://github.com/bridgecrewio/terragoat) ⭐ 1,305 | 🐛 61 | 🌐 HCL | 📅 2025-07-13: Bridgecrew's "Vulnerable by Design" Terraform repository.
* [CloudBrute](https://github.com/0xsha/CloudBrute) ⭐ 1,145 | 🐛 0 | 🌐 Go | 📅 2025-03-09: A multiple cloud enumerator.
* [Sadcloud](https://github.com/nccgroup/sadcloud) ⭐ 788 | 🐛 9 | 🌐 HCL | 📅 2023-10-14: Tool for spinning up insecure AWS infrastructure with Terraform.
...
* AWS
  * [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,318 | 🐛 144 | 🌐 TypeScript | 📅 2026-06-01: Identify vulnerabilities in running containers, images, hosts and repositories.
...
1. [MicroBurst by NetSPI](https://github.com/NetSPI/MicroBurst) ⭐ 2,425 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29: A collection of scripts for assessing Microsoft Azure security
2. [Azure security center workflow automation](https://github.com/Azure/Azure-Security-Center/tree/master/Workflow%20automation) ⭐ 1,930 | 🐛 51 | 🌐 PowerShell | 📅 2026-07-09
...
See [contributing](https://github.com/4ndersonLin/awesome-cloud-security/blob/master/CONTRIBUTING.md) ⭐ 2,483 | 🐛 20 | 📅 2026-03-17
